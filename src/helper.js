...
// Being that our fetchSearch function returns a promise, we want wrapPromise
// to take that promise as an argument.
const wrapPromise = (promise) => {
    // the default state of our promise. We want it to be pending.
    let status = 'pending'
    //result will store the data we got from the promise
    let result = ''
    ...
    return {
        read() {
            ...
            // we should send the result forward
            return result
        }
    }
